...
export const ZH_CN = {
  ...
  // advancedplist
  PICBED_ADVANCEDPLIST: '高级自定义',
  PICBED_ADVANCEDPLIST_ENDPOINT: '设定接口网址',
  PICBED_ADVANCEDPLIST_MESSAGE_ENDPOINT: '例如：https://example.com/upload',
  PICBED_ADVANCEDPLIST_METHOD: '设定请求方法',
  PICBED_ADVANCEDPLIST_MESSAGE_METHOD: '请选择请求方法',
  PICBED_ADVANCEDPLIST_FORM_DATA_KEY: '设定表单参数名',
  PICBED_ADVANCEDPLIST_MESSAGE_FORM_DATA_KEY: '例如：file',
  PICBED_ADVANCEDPLIST_HEADERS: '设定请求头',
  PICBED_ADVANCEDPLIST_MESSAGE_HEADERS: '例如：{"Content-Type": "multipart/form-data"}',
  PICBED_ADVANCEDPLIST_BODY: '设定请求体',
  PICBED_ADVANCEDPLIST_MESSAGE_BODY: '例如：{"key": "value"}',
  PICBED_ADVANCEDPLIST_CUSTOM_PREFIX: '设定自定义前缀',
  PICBED_ADVANCEDPLIST_MESSAGE_CUSTOM_PREFIX: '例如：https://example.com/',
  PICBED_ADVANCEDPLIST_RES_DATA_PATH: '设定返回数据URL路径',
