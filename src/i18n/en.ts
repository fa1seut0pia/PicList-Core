...
export const EN: ILocales = {
  ...
  PICBED_AWSS3PLIST_PROXY: 'Set Proxy',
  PICBED_AWSS3PLIST_URLPREFIX: 'Set Custom URL',
  ...
  PICBED_AWSS3PLIST_MESSAGE_PROXY: 'Ex. http://127.0.0.1:1080',
  PICBED_AWSS3PLIST_MESSAGE_URLPREFIX: 'Ex. https://test.com',
